...
class StroopWordColorPage extends StatefulWidget {
  static const routerName = "/StroopWordColorPage";

  @override
  State<StatefulWidget> createState() {
    return StroopWordColorPageState();
  }
}

class StroopWordColorPageState extends State<StroopWordColorPage> {
  @override
  void initState() {
    // 强制横屏
  ...
  //检查用户测试的对错
  bool _checkRight() {
    return this.testList[this._currentIndex - 1].checkSoundAndColor();
  }
  //按下按钮
  doingTestPress(){
    setState(() {
          ...
          Container(
            ...
            child: TextButton(
              ...
              onPressed: () {
                ...
                //加入该题目结束标志
                testFinishedList[stroopWordColorID]=true;
                Navigator.pushNamedAndRemoveUntil(
                    context, TestNavPage.routerName, (route) => false);
              },
              child: Text(
