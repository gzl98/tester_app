...
//第二个
Widget buildBVMTSecondFragment() {
  return Container(
    alignment: Alignment.center,
    width: maxWidth,
...
class BVMTPage extends StatefulWidget {
  static const routerName = "/BVMTPage";
  @override
            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Column(
                    ...
                    children: [
                      Text("用时："+(this.remainingTime).toString()+"s      ", style: resultTextStyle),
                    ]
                ),
              ),
            ]),
            ...
            child: Stack(
              children: [
                ...
                Positioned(
                    ...
                    child: this.panelShow?buildButtonRect():Container()),
