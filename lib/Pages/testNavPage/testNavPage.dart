...
class testNav extends State<testNavPage>{
  ...
  Widget buildListViewWithTitle(){
    ...
    return Column(children: <Widget>[
      ListTile(
          title:Text("测 试 内 容",textAlign:TextAlign.center,style: listTitleStyle,),
  ...
  Widget getTestListItem(int index){
    ...
    return Container(
      decoration: index==this._selectIndex?new BoxDecoration(color: Color(
          0xFFDFE3E6)) : new BoxDecoration(color: Color(
          0xFFFFFFFF)),
      child: ListTile(
        title: Text("加工速度",style: titleStyle,),
        subtitle: Text("顺序连线",style: subStyle,),
        isThreeLine: false,
        dense: false,
    ...
    return Column(
      children: [
        Expanded(
            ...
            child: Row(
              children: [
                Text("顺序连线",style:subStyle ,),
                Text("加工速度",style: titleStyle,),
              ],
